...
const Card = ({
    ...
    const showViewButton = (showViewProductButton) =>{
        return (
            ...
            showViewProductButton && (<Link to={`/product/${product._id}`} className="mr-2">
    ...
    const showRemoveItemButton = (showRemoveProductButton) =>{
        return (
            showRemoveProductButton && <Link to="/cart">
            <button onClick={()=>removeItem(product._id)} className="btn btn-outline-danger mt-2 mb-2"> Remove</button>
            </Link>
        )
    }
    ...
    return (
            <div className="card">
                ...
                <div className="card-body">
                   ...
                   {showRemoveItemButton(showRemoveProductButton)}
